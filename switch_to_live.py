#!/usr/bin/env python3
"""
ISPConfig API Script - Aliase von Fallback auf Live umschalten

Verschiebt alle Web-Aliase von mep-www-fallback-01 auf mep-www-live-01.

Verwendung:
  ./switch_to_live.py           # Dry-Run (zeigt nur was passieren würde)
  ./switch_to_live.py --execute # Führt die Änderungen aus
"""
...
SOURCE_DOMAIN = 'mep-www-fallback-01.micro-epsilon.de'
TARGET_DOMAIN = 'mep-www-live-01.micro-epsilon.de'
